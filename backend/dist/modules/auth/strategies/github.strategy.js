...
let GithubStrategy = class GithubStrategy extends (0, passport_1.PassportStrategy)(passport_github2_1.Strategy, 'github') {
    constructor(config) {
        super({
            clientID: config.get('app.githubClientId') || '',
            clientSecret: config.get('app.githubClientSecret') || '',
            callbackURL: `${config.get('app.backendUrl') || 'http://localhost:3001'}/api/v1/auth/github/callback`,
