...
const ACTION_LABELS: Record<string, string> = {
  ...
  LOGOUT: "خروج",
  SEND_OTP_FAILED: "ارسال ناموفق OTP",
  FORGOT_PASSWORD_FAILED: "درخواست ناموفق بازیابی رمز",
  RESET_PASSWORD_FAILED: "بازیابی ناموفق رمز",
  SEND_OTP: "ارسال OTP",
  FORGOT_PASSWORD: "فراموشی رمز",
  RESET_PASSWORD: "بازنشانی رمز",
  OAUTH_LOGIN: "ورود با OAuth",
  OAUTH_REGISTER: "ثبت‌نام با OAuth",
  UPDATE_SITE_SETTING: "تغییر تنظیم سایت",
  UPDATE_SITE_SETTINGS: "تغییر تنظیمات سایت",
  DELETE_NEWSLETTER_SUBSCRIBER: "حذف مشترک خبرنامه",
  RESTORE_NEWSLETTER_SUBSCRIBER: "بازگردانی مشترک خبرنامه",
  SEND_NEWSLETTER_CAMPAIGN: "ارسال کمپین خبرنامه",
  SUBSCRIBE_NEWSLETTER: "اشتراک در خبرنامه",
  UNSUBSCRIBE_NEWSLETTER: "لغو اشتراک خبرنامه",
  ...
  RESTORE_ARTICLE: "بازگردانی مقاله",
  RESTORE_ANNOUNCEMENT: "بازگردانی اطلاعیه",
  RESTORE_CONTACT_MESSAGE: "بازگردانی پیام تماس",
  RESTORE_FACULTY: "بازگردانی عضو هیئت علمی",
  RESTORE_FEEDBACK: "بازگردانی بازخورد",
  RESTORE_GALLERY_ITEM: "بازگردانی آیتم گالری",
  UPDATE_FEEDBACK: "تغییر وضعیت بازخورد",
};
...
const ACTION_BADGES: Record<string, string> = {
  ...
  LOGIN_FAILED: "border-red-500/30 bg-red-500/10 text-red-200",
  SEND_OTP_FAILED: "border-red-500/30 bg-red-500/10 text-red-200",
  FORGOT_PASSWORD_FAILED: "border-red-500/30 bg-red-500/10 text-red-200",
  RESET_PASSWORD_FAILED: "border-red-500/30 bg-red-500/10 text-red-200",
  RESTORE_USER: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_ARTICLE: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_ANNOUNCEMENT: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_CONTACT_MESSAGE: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_FACULTY: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_FEEDBACK: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_GALLERY_ITEM: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  RESTORE_NEWSLETTER_SUBSCRIBER: "border-emerald-500/30 bg-emerald-500/10 text-emerald-200",
  SUBSCRIBE_NEWSLETTER: "border-cyan-500/30 bg-cyan-500/10 text-cyan-200",
  UNSUBSCRIBE_NEWSLETTER: "border-amber-500/30 bg-amber-500/10 text-amber-200",
};
